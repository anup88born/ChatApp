...
import {Config, CognitoIdentityCredentials,KinesisVideo} from "aws-sdk";
...
export default async function StartMaster(localView, remoteView, formValues, onStatsReport, onRemoteDataMessage) {
